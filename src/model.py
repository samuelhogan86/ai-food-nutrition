...
class BasicBlock(nn.Module):
	...
	Two 3x3 conv layers with BatchNorm and ReLU, plus an identity or
	projection shortcut when channels/stride differ.
	"""
...
class ResNet18(nn.Module):
	"""Compact ResNet-18-like model built from BasicBlock.

	Uses a 3x3 stem and four layers with channel sizes 64,128,256,512.
	"""
